...
n = 8218   # Число, квадратний корінь якого потрібно знайти
p = 10007  # Просте число, що задовольняє умову
root = cipolla_algorithm(n, p)
print(f"Дискретний квадратний корінь {n} за модулем {p} є {root}")
